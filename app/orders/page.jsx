                ...
                <Card key={order.id} className="overflow-hidden">
                  <CardHeader className="bg-muted/50 py-4">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      ...
                      <Badge 
                        variant="outline" 
                        className={`w-fit flex items-center gap-1 ${statusMap[order.status]?.color}`}
                      >
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="border-t pt-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div className="text-sm text-muted-foreground">
                          <p>Entrega em: {order.shipping_address.street}, {order.shipping_address.number}</p>
                          {order.delivery_date && (
                        ...
                        <div className="text-right">
                          <p className="text-sm text-muted-foreground">
                            Frete: {order.delivery_fee === 0 ? "Grátis" : `R$ ${order.delivery_fee.toFixed(2)}`}
                          </p>
